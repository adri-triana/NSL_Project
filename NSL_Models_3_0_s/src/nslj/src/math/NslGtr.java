/* SCCS  @(#)NslGtr.java	1.6 --- 09/01/99 -- 00:18:16 */
...
public final class NslGtr {
	...
	if (a.length != b.length) {
            System.out.println("NslGtr: boolean[] eval(int[] a, int[] b): Array size inconsistent");
            return dest;
        }
...
/* floats */
	...
	if (a.length != b.length) {
            System.out.println("NslGtr: boolean[] eval(float[] a, float[] b): Array size inconsistent");
            return dest;
        }
...
/* doubles */
	...
	if (a.length != b.length) {
            System.out.println("NslGtr: boolean[] eval(double[] a, double[] b): Array size inconsistent");
            return dest;
        }
