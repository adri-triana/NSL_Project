...
/* floats */
	...
	if (a.length != b.length) {
            System.out.println("NslNeq: boolean[] eval(float[] a, float[] b): Array size inconsistent");
            return dest;
        }
...
/* doubles */
	...
	if (a.length != b.length) {
            System.out.println("NslNeq: boolean[] eval(double[] a, double[] b): Array size inconsistent");
            return dest;
        }
