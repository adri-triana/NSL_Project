...
class NslAreaCanvasProperty extends Dialog implements ActionListener, ItemListener
{
  ...
  public void itemStateChanged(ItemEvent evt)
  {
    ...
    {
        super(parent, "Area Plot Properties",true);
   ...
   private NslAreaCanvas currentCanvas;
