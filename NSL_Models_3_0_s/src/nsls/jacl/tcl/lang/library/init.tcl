...
#
# RCS: @(#) $Id: init.tcl,v 1.1.1.1 1998/10/14 21:09:21 cvsadmin Exp $
#
...
proc auto_load cmd {
	...
	if {$issafe} {
	    ...
	    # Maybe the tclIndex file is in a URL. We can't test
	    # whether it's a valid tclIndex file yet because open
	    # doesn't support URL. We'll just source it and hope it
	    # will work ..
	    #
