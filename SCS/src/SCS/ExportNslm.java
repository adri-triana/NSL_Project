...
class ExportNslm {
	...
	try {
		...
		if (currModule!=null) {
		    tfs= new TableFileSelector(parentFrame,"Module",wantFile,currDirStr, currModule);
		} else {
		    tfs= new TableFileSelector(parentFrame,"Module",wantFile,currDirStr);
		}
	    } else {
		    tfs= new TableFileSelector(parentFrame,"Module",wantFile);
	    }
	}//end try
