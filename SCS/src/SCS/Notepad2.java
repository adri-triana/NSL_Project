...
map.addActionForKeyStroke(prev,getAction(DefaultEditorKit.backwardAction));
    ...
    */
	...
	ReplaceAction(String nm) { //called by replaceAgainAction
		...
		isReplaceAgain=true;
		lastExistingString=lastExistingString;
	    } else {
		isReplaceAgain=false;
		lastExistingString="";
	    }
	    globalReplace=false;
	    StringStringBooleanBoolean content = new StringStringBooleanBoolean(lastExistingString,lastReplacementString,forwardReplaceDirection,globalReplace);
