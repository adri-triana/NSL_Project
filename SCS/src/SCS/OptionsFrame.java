...
public class OptionsFrame extends Dialog
    ...
    public static  Integer connectionWidth =new Integer(2);  
	...
	for ( int count = 0 ; count < fontlist.length  ; count++)
	    {
		freeTextFontNameChoice.add(fontlist[count]) ;
	    }
	...
	freeTextSizeChoice.select(new Integer(freeTextSize).toString()) ;        
	...
	for ( int count = 0 ; count < fontlist.length  ; count++) {
	    moduleTextFontNameChoice.add(fontlist[count]) ;
	}
	...
	moduleTextSizeChoice.select(new Integer(moduleTextSize).toString());
	...
	for ( int count = 0 ; count < fontlist.length  ; count++)
	    {
		instanceTextFontNameChoice.add(fontlist[count]) ;
	    }
	...
	instanceTextSizeChoice.select(new Integer(instanceTextSize).toString()) ;        
    ...
    */
	...
	freeTextSize = new Integer (freeTextSizeChoice.getSelectedItem()).intValue();
	...
	moduleTextSize = new Integer (moduleTextSizeChoice.getSelectedItem()).intValue();
	...
	instanceTextSize = new Integer (instanceTextSizeChoice.getSelectedItem()).intValue();
	instanceTextFont=new Font(instanceTextFontName,Font.BOLD,instanceTextSize);
