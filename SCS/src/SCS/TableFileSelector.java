...
//todo: change tfs to be like the other dialogs and do a display
     ...
     * TableFileSelector
     * @param fm 
     * @param modelOrModuleStr
     * @returnFileFlag   
     */
    public TableFileSelector(  Frame  fm , String modelOrModuleStr, boolean returnFileFlag)  throws FileNotFoundException, IOException {
     ...
     * @inDirStr
     */
    public TableFileSelector(  Frame  fm , String modelOrModuleStr, boolean returnFileFlag, String inDirStr)  throws FileNotFoundException, IOException {
     ...
     * @inModule
     */
    public TableFileSelector(  Frame  fm , String modelOrModuleStr, boolean returnFileFlag, String inDirStr, Module inModule)  throws FileNotFoundException, IOException {
     ...
     * @inModule
     */
    public void initTableFileSelector(Frame  fm , String modelOrModuleStr, boolean returnFileFlag, String inDirStr, Module inModule)  throws FileNotFoundException, IOException {
	...
	try {
	    ...
	    System.err.println("Error:TableFileSelector:constructor:2 File not fould exception : "+SCSUtility.scs_library_paths_file);
	    //todo: popup warning 
	...
	libraryList.setSelectionMode(0);  
	...
	for ( i = 0; i < fileList.length  ; i++ ) {
	    ...
	    if ( tempfile != null ) {
		if ( tempfile.isDirectory() == true  &&  ( albumdir.getName().equals(blankString) == false ) )
		    {
    ...
    */
	...
	if (libraryList==null) {	
	    ...
	    String temp42=(String)libraryList.getSelectedValue();
	    if (temp42==null) {
	...
	if (libraryList==null) {	
	    ...
	    String libPath=(String)libraryList.getSelectedValue();
	    if (libPath==null) {
		System.err.println("Error:TableFileSelector: library List getSelectedValue is null.");
		return (null);
	    } else {
		libPath=libPath.trim();
		String libNickName=getLibNickNameFromVector(libPath);
		return  (libNickName) ;
	    }
	}
    }
	...
	if (temp32==null) {
	    ...
	    String temp33=(String)moduleList.getSelectedValue();
	    if (temp33==null) {
		System.err.println("Error:TableFileSelector: module List getSelectedValue is null.");
		return(null);
	    } else {
		String temp34=temp32 + File.separator +temp33 ;
		return (temp34);
	    }
	}
    }
	...
	String temp82=returnModulePath();
	    ...
	    String temp83= (String)versionList.getSelectedValue( );
	    if (temp83==null) {
		System.err.println("Error:TableFileSelector: version List getSelectedValue is null.");
		return(null);
	    } else {
		String temp84=temp82+File.separator+temp83;
		return (temp84);
	    }
	}
    }
	...
	String mytemp3 = returnVersionPath();
	    ...
	    String mytemp4 = mytemp3+File.separator+"src";
	    return (mytemp4);
      	} 
    }
    //-------------------------------------------------------------
	...
	if (mytemp5==null) {
		...
		String mytemp7 = mytemp5+File.separator+mytemp6;
		return (mytemp7);
	    }
	}
    }
	...
	if (moduleList==null) {
	    ...
	    String mytemp11 = (String) moduleList.getSelectedValue(); 
	    String mytemp22 = mytemp11+".sif";
	    return (mytemp22);
	}
	...
	if (event.getSource() instanceof JList ) 
		...
		if ( templist.equals(libraryList) == true )
		    {
			...
			File albumdir = new File( (String)  libraryList.getSelectedValue() );

			moduledata = returnDirList( (String)  libraryList.getSelectedValue() );
		...
		if ( templist.equals(moduleList) == true )
		    {
			...
			versiondata= returnDirList(new File( (String)   libraryList.getSelectedValue() , (String)  moduleList.getSelectedValue() ).getAbsolutePath() );
			versionList.setListData( versiondata ) ;

			versionList.setVisibleRowCount(maxElementsInDir/3);	     	versionList.validate();
			versionList.repaint() ;
	...
	if (actionLabel.equals("OK")) {
	    libraryName = (String)libraryList.getSelectedValue();
	    libraryPath = returnLibraryPath();
	    SCSUtility.setCurrLibPath(libraryPath);
	    moduleName = (String)moduleList.getSelectedValue();
	    modulePath = returnModulePath();
	    versionName = (String)versionList.getSelectedValue();
