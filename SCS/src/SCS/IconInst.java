...
class IconInst extends Icon {
    ...
    String instanceName="";
    boolean getCurrentVersion=true; //float this version =0; specific version=1
    String parameters="";
 ...
 *					instance of an icon
 * @param    	getCurrentVersion	always use the same specific version of
 ...
 */
    public void writeAllChars(PrintWriter pw){
	    ...
	    boolean xminZeroed=false;  //for instances we do not zero
	    super.writeAllChars(pw,xminZeroed); //write the icon info
	}
 ...
 */
	...
	// we go and get the same module againg because its looks
