 ...
 * @version     %I%, %G%
 *
 * @param       parentFrame          pointing to the parentFrame--IconEditorFrame
 * *var       shapeMenu	a popup menu containing different choices of 
 *				shapes to be inserted to the icon panel
 * *var       status		a flag indicating the current status of 
...
*/
    ...
    String status=null;
    WarningDialog warningPopup4=null;
    WarningDialogOkCancel okCancelPopup4=null;
