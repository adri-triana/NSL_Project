...
class IconInport extends GraphicPart_line {
     ...
     * @version     1.1, 03/15/99
     *
     * @param       Name	the name of this icon inport
     * @param       Type	the type of this icon inport, either Java native data 
     ...
     * @param       direction   direction of the icon port
     * @param       signalType  excitatory or inhibitory. E or I
     * @param	link	the hookup to a connection from this icon inport
     *
     * @since       JDK1.1
     */
     ...
     *
     * @param       Name	the name of this icon inport
     * @param       Type	the type of this icon inport as it would appear in
     *                      the NSLM code
     * @param       signalType  excitatory or inhibitory. E or I
     * @param       parameters	the parameters of the corresponding variable
     *				representation of this icon inport
