...
class IconOutport extends GraphicPart_line {
	...
	if ( IconOutport.output_port_shape.equals("CROSS") == true )
	    {       paint_cross(g); return ; }
  
	if ( IconOutport.output_port_shape.equals("ARROW") == true )
	    {       paint_arrow(g); return ; }
	...
	if (links!=null) {
		...
		Connection conn=(Connection)links.elementAt(ix);
		pw.print("link num: ");
