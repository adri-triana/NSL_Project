...
class ModuleNewDialog extends JDialog 
    ...
    WarningDialogOkCancel okCancelPopup=null;
    String status = "none" ; 
...
public  int isValidString(String inputString )
    {
      if (  ( inputString==null ) ||
        ( inputString.equals("") == true ) || ( inputString.indexOf(" ") != -1 ) ) 
...
public  int isValidType(String inputString ) {
	...
	status= -1 ;  //error
      ...
      else if (( inputString.equals("NslModel") == true ) ||
		( inputString.equals("NslModule") == true ) ||
		( inputString.equals("NslClass") == true ) ||
	        ( inputString.equals("NslInModule") == true ) ||
		( inputString.equals("NslOutModule") == true )) {
...
//-------------------------------------------------
	...
	status=-1 ;  //error
      ...
      else if (( inputString.equals("true") == true ) ||
	       ( inputString.equals("false") == true )) {
		status=0 ;  // no error
	}
	return (status) ;  // error
}
...
//-------------------------------------------------
	...
	if (event.getSource() instanceof Button) {
		...
		libNickAndPath =( String )  nickAndLibChoice.getSelectedItem() ;
		...
		boolean found=parentFrame.executiveFrame.windowsAndModulesOpen.contains(sm); //there could be many
		if (found) {
		    errorStatus=15;
		...
		foundInOtherEditor=parentFrame.executiveFrame.windowsAndModulesOpen.containsModule(libNickName,moduleName,versionName);
