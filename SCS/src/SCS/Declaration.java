...
public class Declaration extends Object {
 ...
 /**
	...
	varCatagoryType=var.varCatagoryType;
	 ...
	 * @version     %I%, %G%
	 *
	 * @param       varName	the name of this variable declaration
	 * @param       varScope	the scope of this variable declaration
	 * @param       varConstant
	 * @param       varCatagoryType	the type of this variable declaration without dim
	 * @param       varDimensions
	 * @param       varType	the type of this variable declaration with dim
	 * @param       varParams	an string of parameters of this variable declaration
	 * @param       varInits	initial value of this variable declaration
	 * @param       varDialogType   
	 * @param       varComment
	 * @param       portBuffering
	...
	bob.varCatagoryType=this.varCatagoryType;
    ...
    /*
      ...
      varCatagoryType=newguy.varCatagoryType;
    ...
    */
	...
	if ((varScope.equals("private"))||(varScope.equals("public"))||(varScope.equals("protected"))) {
	    return(false);
	} 
	return(true);
    }
	...
	boolean myequal=false;
	if (infoo==null) {
	    return(myequal=false);
	}
	if (infoo instanceof String){
	    if (varName.equals(infoo)) {
		return(myequal=true);
	    } else {
		return(myequal=false);
	    }
	...
	if (infoo instanceof Declaration) {
	    ...
	    if (varName.equals(((Declaration)infoo).varName)) {
		return(myequal=true);
	    } else {
		return(myequal=false);
	    }
	...
	pw.print((new Boolean(varConstant)).toString()); 
	pw.print("\n"); 
	pw.print("varCatagoryType: "); 
	pw.print(varCatagoryType); 
	pw.print("\n"); 
	...
	pw.print((new Boolean(portBuffering)).toString()); 
	pw.print("\n"); 
	...
	pw.print((new Boolean(modGetCurrentVersion)).toString()); 
	pw.print("\n"); 
	pw.print("modGetCurrentVersion: "); 
	...
	if (varDialogType.equals("BasicVariable")) {
	    ...
	    pw.print(varType+" "+varName); 
	    if (!(varParams.equals(""))) {
		if (varCatagoryType.startsWith("Nsl")) { //Nsl vs Native
		    pw.print("("+varParams+")");
