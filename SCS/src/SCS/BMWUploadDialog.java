...
public class BMWUploadDialog extends JDialog
  ...
  // constructor
	...
	if (source instanceof JRadioButton) {
	    ...
	    if (command.equals("Zip Library")) zipLibrary=true;
	    else if (command.equals("Zip Model")) zipModel=true;
	    else if (command.equals("Zip Module")) zipModule=true;
	    else if (command.equals("Hierarchical Zip")) hierarchicalZip=true;
	    else if (command.equals("Just Me Zip")) justMeZip=true;
	    else {
