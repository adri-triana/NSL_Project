...
class NslmEditorFrame extends EditorFrame
    ...
    // layout
    //                                     title
    JMenuBar nslmMenuBar=null;            // nslmMenuBar - must be AWT type
    JPanel myNslmEditorPanel=null;   // 
    JScrollPane  myNslmPane=null;       // myNslmPane contains myNslmEditorPanel
...
//todo:should query the environment to see how big the users screen is
    ...
    JList declJList;
    DefaultListModel declJListModel;
    ...
    MessageDialog messagePopup=null;
   ...
   */
    ...
    //------------------------------------------------------------------------
    public void fillDeclarationModel(DefaultListModel declJListModel) {
	...
	declJListModel = new DefaultListModel();
   ...
   */
	...
	if (methodsPanel==null) {
	    warningPopup.display("NslmEditorFrame: notepad2 returned null.");
	    return(null);
	}else {
   ...
   /** -------------------------------------------------------------*/
	...
	DeclarationDialog myDialog=null;
	/*
   ...
   */
	...
	if (event.getSource() instanceof JButton) {
	    ...
	    */
		...
		int ivector;
		selectedVarStr=null;
		selectedVarStr=(String)declJList.getSelectedValue();
	...
	if (okPressed) {
	    ...
	    if (var==null) {
		String errstr="NslmEditorFrame:var is null";
		warningPopup.display(errstr);
		return;
	    }
